...
bool Fixed::operator<(Fixed const& other) const { return m_fixedValue < other.m_fixedValue; }
bool Fixed::operator>(Fixed const& other) const { return m_fixedValue > other.m_fixedValue; }
bool Fixed::operator<=(Fixed const& other) const { return m_fixedValue < other.m_fixedValue || m_fixedValue == other.m_fixedValue; }
bool Fixed::operator>=(Fixed const& other) const { return m_fixedValue > other.m_fixedValue || m_fixedValue == other.m_fixedValue; }
bool Fixed::operator==(Fixed const& other) const { return m_fixedValue == other.m_fixedValue; }
bool Fixed::operator!=(Fixed const& other) const { return !(m_fixedValue == other.m_fixedValue); }
...
Fixed& Fixed::operator++() { m_fixedValue++; return *this; }
Fixed  Fixed::operator++(int) { Fixed copy(*this); m_fixedValue++; return copy; }
Fixed& Fixed::operator--() { m_fixedValue++; return *this; }
Fixed  Fixed::operator--(int) { Fixed copy(*this); m_fixedValue--; return copy; }
